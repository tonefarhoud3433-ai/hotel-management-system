...
function NavBar() {
  ...
  return (<>
            ...
            <Box sx={{ flexGrow: 0 }}>
              <Tooltip title="Open settings">
                <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                  <Box sx={{ width: 32, height: 32, borderRadius: '50%' }} crossOrigin='anonymous' component={'img'} alt="Remy Sharp" src={profile?.profileImage ? profile?.profileImage : noImageProfile} />
                </IconButton>
              </Tooltip>
              <Menu
                sx={{ mt: '45px' }}
    ...
    <DeleteConfirmations
      ...
      btnText="Log out"
      onDelete={logOut} open={confirmLogOut} onClose={() => setConfirmLogOut(false)} />
