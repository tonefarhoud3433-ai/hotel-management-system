  ...
  return (
    ...
    >
      ...
      <Grid container spacing={2}>
        ...
        <Grid size={12} display="flex" flexDirection="column" alignItems="center" justifyContent="center" sx={{}}>

          <Box position="relative" onClick={handleImageClick} sx={{ cursor: 'pointer', width: 'fit-content', borderRadius: '50%', mx: 'auto' }}>
            <Avatar
              src={previewImage}
              sx={{
                width: 100,
            ...
            >
              ...
              <AddAPhotoIcon sx={{ color: 'rgba(21, 44, 91, 0.6)', fontSize: 32 }} />
            </Avatar>
          </Box>
          {previewImage && (
            <IconButton
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
            ...
            <Typography variant="subtitle2" sx={{ color: "rgba(21, 44, 91, 1)", fontWeight: 500 }}>
                ...
                endAdornment: (
                  <InputAdornment position="end" sx={{ mr: 2 }}>
                    ...
                    <IconButton onClick={() => setShowConfirmPassword(!showConfirmPassword)} edge="end">
                      {showConfirmPassword ? <VisibilityOff sx={{ color: '#a0aec0' }} /> : <Visibility sx={{ color: '#a0aec0' }} />}
                    </IconButton>
                  </InputAdornment>
                ),
              }
