...
export default function ChangePassword() {
  ...
  const { register, handleSubmit, formState: { errors }, watch } = useForm<ChangePasswordData>({ resolver: yupResolver(changePasswordSchema) });
  ...
  return <form onSubmit={handleSubmit(onSubmit)}>
    <Box sx={{ mb: 3 }}>
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        You can <Link className='customLink_register' to="/dashboard/home"> Back To Home !</Link>
      </Typography>
      </Box>
            ...
            endAdornment: (
              <InputAdornment position="end" sx={{ mr: 2 }}>
                <IconButton onClick={() => setShowOldPassword(!showOldPassword)} edge="end">
                  {showOldPassword ? <VisibilityOff sx={{ color: '#a0aec0' }} /> : <Visibility sx={{ color: '#a0aec0' }} />}
                </IconButton>
              </InputAdornment>
            ),
          }
