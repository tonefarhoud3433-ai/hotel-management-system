...
export default function RoomDetails() {
  ...
  if (!roomData) {
    return (
      <Typography sx={{ p: 20, mx: "auto" }}>
        Loading Room Data... <GradientCircularProgress />
      </Typography>
    );
  }
            ...
            {roomData.images?.map((imgSrc, index) => (
              ...
              >
                <Box
                  ...
                  sx={{
                    width: "100%",
                    height: roomData.images.length == 1 ? "400px" : "200px",
                    objectFit: "cover",
                    borderRadius: 2,
                    mx: "auto",
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Typography
                      component={"span"}
                      sx={{ color: "gray", fontSize: "16px", ml: 0.5 }}
                    >
                      / night
                    </Typography>
                  </Typography>
                ...
                >
                  ...
                  >
                    ...
                    {roomData.discount > 0 && (
                      ...
                      >
                        ${(roomData.price * days).toFixed(2)}
                      </span>
                    )}
                    ${totalPrice.toFixed(2)} for {days} night(s)
                  </Typography>
                  ...
                  <Button
                    onClick={
                      token
                        ...
                        : () =>
                            navigate("/auth/login", {
                              state: { curunteLocation: `/roomdetails/${id}` },
                            })
                    }
                    disabled={loading}
                    fullWidth
                    variant="contained"
                    sx={{ bgcolor: "#1ABC9C", py: 1.5, cursor: "pointer" }}
                  >
                    {token
                      ? loading
                        ? "Processing..."
