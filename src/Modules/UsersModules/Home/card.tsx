...
const PropertyCard = ({card}:{card:CardData}) => {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ position: 'relative', borderRadius: '12px', overflow: 'hidden' }}>
        ...
        <Box
          ...
          sx={{
            ...
            top: 0,
            right: 0,
            backgroundColor: '#FF385C', // Vibrant hot pink matching the sticker in image_291e44.jpg
            color: '#FFFFFF',
            padding: '12px 24px',
            borderBottomLeftRadius: '12px', // Curved inner corner styling
            opacity: 0, // Hidden by default
            transform: 'translateY(-5px)', // Subtle slide-in effect
      ...
      {/* Card Content */}
      <CardContent sx={{ px: 2, pt: 2, pb: 0, '&:last-child': { pb: 0 } }}>
        <Typography 
          variant="h4" 
          component="div" 
          sx={{ 
